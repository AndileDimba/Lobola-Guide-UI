  ...
  steps: [
    {
      ...
      description:
        "The formal opening of the marriage process where intent is declared.",
      details: [
    ...
    },
    {
      ...
      title: "Imvula Mlomo",
      description:
        'The "mouth opener" meeting to establish a relationship between families.',
      details: [
    ...
    },
    {
      ...
      description:
        "The core negotiation of the bride price and traditional gifts.",
      details: [
    ...
    },
    {
      ...
      title: "uMembeso",
      description:
        "The groom's family brings gifts to thank the bride's family.",
      details: [
    ...
    },
    {
      ...
      description:
        "The final ceremony where the bride is integrated into the groom's family.",
      details: [
